...
public class WXNavigatorModule extends WXModule {
    ...
    private static String intentCategory = "com.f.use.weexdemo.android.intent.category.WEEX.pushMessage";

    public static void setIntentCategory(String intentCategory) {
        WXNavigatorModule.intentCategory = intentCategory;
    }
